...
export interface ActionAudit {
  ...
  acteur: string;
  roleActeur: string;
  typeAction: 'CREATION_DOSSIER' | 'TELEVERSEMENT_PIECE' | 'VERIF_BIOMETRIQUE' | 'PAIEMENT' | 'INSTRUCTION' | 'DEMANDE_COMPLEMENT' | 'DECISION_VALIDATION' | 'DECISION_REJET' | 'CONSULTATION' | 'VERIFICATION_TIERS' | 'EXPORT_CERTIFICAT';
  objetId: string;
  horodatage: string;
  adresseIP: string;
  details: string;
